      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            className="p-1.5 rounded-lg border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-600 transition-colors"
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {uniqueSpecies.length > 1 && (
          <div className="flex items-center gap-2">
            <span className="text-sm text-slate-500 dark:text-slate-400">Species:</span>
            <select
        ...
        {uniqueStations.length > 1 && (
          <div className="flex items-center gap-2">
            <span className="text-sm text-slate-500 dark:text-slate-400">Station:</span>
            <select
